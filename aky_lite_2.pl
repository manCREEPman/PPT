...
predicates_dir(Path):- Path = 'D:/7/predicates/'.
...
% 1-й вопрос
question1(X1):-
    question_constructor('У вашего персонажа есть скиллы-модификаторы атаки(автоприменяемые)?',
                         'Нет',
                         'Да'),
    read(X1).
...
% 2-й вопрос
question2(X2):-
    question_constructor('Ваш персонаж может уходить в невидимость?',
                         'Нет',
                         'Да'),
    read(X2).
...
% 3-й вопрос
question3(X3):-
    question_constructor('У вашего персонажа есть пассивные способности(полу-активные тоже считаются)?',
                         'Нет',
                         'Да'),
    read(X3).
...
% 4-й вопрос
question4(X4):-
    question_constructor('У вашего персонажа есть способности с оглушением/оцепенением/страхом?',
                         'Нет',
                         'Да'),
    read(X4).
...
% 5-й вопрос
question5(X5):-
    question_constructor('У вашего персонажа есть замедляющие способности?',
                         'Нет',
                         'Да'),
    read(X5).
...
% 6-й вопрос
question6(X6):-
    question_constructor('У вашего персонажа есть способности с безмолвием?',
                        'Нет',
                        'Да'),
    read(X6).
...
% 7-й вопрос
question7(X7):-
    question_constructor('Ваш персонаж может вызывать подконтрольные юниты/иллюзии',
                         'Нет',
                         'Да'),
    read(X7).
...
% 8-й вопрос
question8(X8):-
    question_constructor('Ваш персонаж может наносить урон по области?',
                         'Нет',
                         'Дат'),
    read(X8).
...
% 9-й вопрос
question9(X9):-
    question_constructor('Ваш персонаж обладает способностями на мобильность (телепортация, блинки)',
                         'Нет',
                         'Да'),
    read(X9).
...
% 10-й вопрос
question10(X10):-
    question_constructor('Какой тип атаки у вашего персонажа?',
                         'Ближний',
                         'Дальний'),
    read(X10).
...
% 11-й вопрос
question11(X11):-
    question_constructor('Ваш персонаж может лечить союзников?',
                         'Нет',
                         'Да'),
    read(X11).
...
% 12-й вопрос
question12(X12):-
    question_constructor('Ваш персонаж имеет способность, усиливающую его или союзников (скиллы, которые имеют другие механики помимо бафа не считаются)?',
                         'Нет',
                         'Да'),
    read(X12).
...
% 13-й вопрос
question13(X13):-
    question_constructor('Ваш персонаж может влиять на ландшафт карты(ломать деревья, создавать преграды)?',
                         'Нет',
                         'Да'),
    read(X13).
...
add_hero(X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X12, X13, Hero, Res):-
	load,
	name(AtomHero, Hero),
	assert(AtomHero,
			X1, X2, X3, X4,
...
run(X1, X2, X3, X4, X5, X6, X7, X8, X9, X10, X11, X12, X13, X):-
    load/*,
